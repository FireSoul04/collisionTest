...
import com.firesoul.collisiontest.model.impl.GameObjectBuilderImpl;
...
public class RegularPolygons implements GameLogic {
    ...
    public RegularPolygons(final SwingRenderer renderer) {
        ...
        playerBuilder = playerBuilder.collider(new MeshCollider(GameCore.regularPolygon(5), 50.0, 0.0));
        ...
        triBuilder = triBuilder.collider(new MeshCollider(GameCore.regularPolygon(3), 50.0, 0.0));
        ...
        circleBuilder = circleBuilder.collider(new MeshCollider(GameCore.regularPolygon(50), 50.0, 0.0));
