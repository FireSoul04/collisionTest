...
public class SwingDrawableFactory implements DrawableFactory {
	...
	@Override
	public Drawable spriteByName(final String name, final Vector2 position) {
		return this.baseSpriteByName(name, position, true);
	}

	@Override
	public Drawable invisibleSpriteByName(final String name, final Vector2 position) {
	...
	private Drawable baseSpriteByName(final String name, final Vector2 position, final boolean visible) {
